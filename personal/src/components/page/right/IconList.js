...
import { StyledIconList } from "../../../styles/main";
...
const icons = [ajax, api, bootstrap, css, express, git, google, heroku, html, jquery, js, json, mongodb, mysql, nodejs, php, react, redux, semanticui]
