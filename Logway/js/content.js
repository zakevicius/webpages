var contentLT = {
  headerLinks: [["Ką mes siūlome?", "#bodyCont"], ["Susisiekim", "#form"]],
  customsContent: [
    "Importo procedūros",
    "Eksporto procedūros",
    "Tranzito procedūros",
    "Tarpininkavimas muitinėje",
    "Muitinės sandėliavimo procedūros",
    "Važtaraščių ir TIR knygelių pildymas"
  ],
  warehouseContent: [
    "Sandėliavimas",
    "Krovos darbai",
    "Muitinės sandėliavimas",
    "Papildomi sandėlio darbai",
    "Krovinio apdirbimo darbai",
    "Nestandartinių krovinių krovimas"
  ],
  formContent: {
    contactTitle: "Susisiekite su mumis",
    contactText: [
      "Jei turite klausimų, drąsiai kreipkitės.",
      "Atsakysim, patarsim, padėsim."
    ],
    formFields: {
...
var contentRU = {
  headerLinks: [["Что мы предлагаем?", "#bodyCont"], ["Пообщаемся", "#form"]],
  customsContent: [
    "Импортные процедуры",
    "Экспортные процедуры",
    "Транзитные процедуры",
    "Таможенное оформление",
    "Таможенные складские процедуры",
    "Заполнения ЦМР и книжек МДП"
  ],
  warehouseContent: [
    "Складирование",
    "Грузовые операции",
    "Таможенное складирование",
    "Дополнительные складские работы",
    "Обработка грузов",
    "Крупногабаритные и негабаритные грузы"
  ],
  formContent: {
    contactTitle: "Свяжитесь с нами",
    contactText: [
      "Возникли вопросы? Обращайтесь - ответим, посоветуем, поможем."
    ],
    formFields: {
...
var contentEN = {
  headerLinks: [["What we offer?", "#bodyCont"], ["Contact us", "#form"]],
  customsContent: [
    "Import procedures",
    "Export procedures",
    "Transit procedures",
    "Customs Brokerage",
    "Customs warehouses",
    "Filling of CMR and TIR Carnets"
  ],
  warehouseContent: [
    "Warehousing",
    "Loading/unloading operations",
    "Customs warehousing",
    "Custom cargo operations",
    "Additional cargo processing works",
    "Bulky cargo operations"
  ],
  formContent: {
    contactUs: "Contact Us",
    contactHelp: [
      "Have any questions? Feel free to contact us",
      "We are here to answer, advice and help."
    ],
    formFields: {
